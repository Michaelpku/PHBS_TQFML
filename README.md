...
- Confusion matrix is also used to examine the predictive power of the model.  The result is quite disappointing.  16 observations were predicted to be negative, while they were positive.![Confusion Matrix](https://github.com/Michaelpku/PHBS_TQFML/tree/master/Project/Picture/1.JPG)
